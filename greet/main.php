...
You provided us with the following information: <break time="500"/> 
...
your property is ' . $user_data["cropsize"] . ' big, and the latest crop you reported was ' . $user_data["latestcrop"] .
        '<break time="100"/> Thank you for using our service. Very soon you will be able to hear custom made advices for your crops',
]);
